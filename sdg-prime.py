...
# Ancient gods â€” matches the Java hostname implementation exactly
HOSTNAMES = [
...
STAR_TREK_CHARACTERS = [
    "Jean-Luc Picard", "William Riker", "Data", "Geordi La Forge", "Worf",
    "Deanna Troi", "Beverly Crusher", "Wesley Crusher", "Tasha Yar", "Guinan",
    "Miles O'Brien", "Reginald Barclay", "Katherine Pulaski", "Q", "Lwaxana Troi",
    "Ro Laren", "Lore", "Hugh", "Alexander Rozhenko", "K'Ehleyr", "Thomas Riker",
    "Vash", "Gowron", "Martok", "Sela", "Toral", "Ardra", "Nagilum", "Armus",
    "The Traveler", "Boothby", "Admiral Nechayev", "Admiral Haftel", "Admiral Nakamura",
    "Captain Jellico", "Commander Shelby", "Lieutenant Ogawa", "Nurse Alyssa Ogawa",
    "Lieutenant Commander Daren", "Ensign Sito Jaxa", "Simon Tarses", "Lieutenant Selar",
    "Sonya Gomez", "Mot", "Moriarty", "Minuet"
]
...
# â”€â”€ Primitives  (Faker) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Names  (Faker) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def gen_group(_field: Dict) -> str:
    """Department/group â€” Faker's bs() gives realistic business unit names."""
    return fake.bs().title()


# â”€â”€ Names  (custom â€” no Faker equivalent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

def gen_team_name(_field: Dict) -> str:
    return random.choice(TEAM_NAMES)


# â”€â”€ Addresses  (Faker) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Special numbers  (Faker) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Special numbers  (custom â€” no Faker equivalent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

def gen_product_name(_field: Dict) -> str:
    return random.choice(PRODUCT_NAMES)


# â”€â”€ Random from lists  (custom â€” inherently user-defined) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Misc  (Faker) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Misc  (custom â€” no Faker equivalent) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
GENERATORS: Dict[str, Any] = {
    # â”€â”€ Official types (supported_fields.md) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    # Primitives
    "int":                      gen_int,            # Faker
    ...
    # â”€â”€ Aliases / extras â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    "integer":                  gen_int,
    "long":                     gen_long,
    "double":                   gen_double,
    "bool":                     gen_boolean,
...
def generate_value(field: Dict, state: Optional[Dict] = None) -> Any:
    ...
    if generator is None:
        log.warning("Unknown field type '%s' for field '%s' â€” returning empty string",
...
def build_document(fields: List[Dict], seq_state: Dict) -> Dict:
    ...
    for field in fields:
        ...
        # Dot-notation â†’ nested dict  e.g. "name.first" â†’ {"name": {"first": â€¦}}
        if "." in key:
            parts     = key.split(".")
            container = doc
            for part in parts[:-1]:
...
def _peak_multiplier(peak_time_str: Optional[str]) -> float:
    ...
    Near peak â†’ ~0.5 (faster).  Far from peak â†’ ~2.0 (slower).
    Uses local host time â€” identical to the Java implementation.
    """
    ...
    def run(self):
        ...
        while not self.stop_event.is_set():
            try:
                ...
                log.error("[%s] Connection error: %s â€” retrying in 5s", self.name, ex)
                self.errors += 1
...
def main():
    parser = argparse.ArgumentParser(
        description="Simple Data Generator (Python) â€” streams random data to Elasticsearch"
    )
